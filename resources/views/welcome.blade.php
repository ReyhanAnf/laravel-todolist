<x-layout>
    <main class="flex flex-col items-center justify-center gap-4">
        ...
        <blockquote class="relative text-center max-w-lg mx-auto">
            <div class="relative z-10">
              <p class="text-xl text-gray-800">
                <em class="relative">
                  <svg class="absolute -top-8 -start-8 size-16 text-gray-100 sm:h-24 sm:w-24 dark:text-neutral-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <span class="relative z-10 dark:text-white">Tuliskan, selesaikan, dan saksikan mimpimu menjadi nyata. Ayo kelola tugas harianmu!</span>
                </em>
              </p>
            </div>
          </blockquote>
        <div class="flex flex-row gap-5 w-1/3">
            ...
            <a href="{{ route('register') }}" class="py-3 my-5 px-4 inline-flex w-full text-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-100 text-teal-800 hover:bg-teal-200 focus:outline-none focus:bg-teal-200 disabled:opacity-50 disabled:pointer-events-none dark:text-teal-500 dark:bg-teal-800/30 dark:hover:bg-teal-800/20 dark:focus:bg-teal-800/20">
                Register
            </a>
        </div>
    </main>
