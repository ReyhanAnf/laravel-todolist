<form action="/task/add" method="post" class="w-full px-10">
    @csrf
    ...
    <div class="space-y-3 flex flex-col gap-4">
        ...
        <div class="relative">
            ...
            <textarea id="input-desc" name="description"
                ...
                rows="3" placeholder="somthing.." data-hs-textarea-auto-height=""></textarea>
        </div>
        ...
        <div class="relative">
            ...
            <button id="add-task-btn" type="submit" value="Task" name="submit"
